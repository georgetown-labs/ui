...
| master                                                                                                                                                                                                                                                             | develop                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![Travis 'master' build status](https://travis-ci.org/georgetown-labs/ui.svg?branch=master)](https://travis-ci.org/georgetown-labs/ui) [![codecov](https://codecov.io/gh/georgetown-labs/ui/branch/master/graph/badge.svg)](https://codecov.io/gh/georgetown-labs/ui) | [![Travis 'develop' build status](https://travis-ci.org/georgetown-labs/ui.svg?branch=develop)](https://travis-ci.org/georgetown-labs/ui) [![codecov](https://codecov.io/gh/georgetown-labs/ui/branch/develop/graph/badge.svg)](https://codecov.io/gh/georgetown-labs/ui) |
